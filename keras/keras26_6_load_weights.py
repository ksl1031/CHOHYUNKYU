...
# model.load_weights('./_save/keras26_5_save_weights1.h5') # 가중치 저장 X
# 얘는 초기 랜던값의 웨이트만 저장되어 있다. loss 값이 매우 안좋음
model.load_weights('./_save/keras26_5_save_weights2.h5') # 가중치 저장 O 컴파일은 해줘야한다.
