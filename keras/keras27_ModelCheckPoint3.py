...
mcp = ModelCheckpoint(monitor='val_loss',
                      ...
                      filepath='./_save/MCP/keras27_3_MCP.hdf5') # filepath : 파일의 경로를 나타내는 문자열 = 현재 경로에 파일 생성 저장
...
loss = model2.evaluate(x_test, y_test,verbose=0) # loss 출력 값 제거
print("loss : ", loss)
...
loss = model3.evaluate(x_test, y_test,verbose=0) # loss 출력 값 제거
print("loss : ", loss)
...
# ====================== 1. 기본 출력 ===========================
# loss :  22.83686065673828
# r2 스코어 :  0.7671584458551497
# ====================== 2. load_model 출력 ===========================
# loss :  22.83686065673828
# r2 스코어 :  0.7671584458551497
# ====================== 3. MCP 출력 ===========================
# loss :  23.130970001220703
# r2 스코어 :  0.7641597588613824
